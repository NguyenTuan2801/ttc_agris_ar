...
public class DevicePresenter
{
    ...
    private DeviceRequestDto ConvertToRequestDto(DeviceInformationModel model)
    {
        return new DeviceRequestDto(
            ...
            outputSignal: model.OutputSignal,
            ingressProtection: model.IngressProtection,
            connectorType: model.ConnectorType,
            processConnection: model.ProcessConnection,
            responseTime: model.ResponseTime,
            otherSpecifications: model.OtherSpecifications,
            installationLocation: model.InstallationLocation,
            measuredMedium: model.MeasuredMedium,
            operatingTemperature: model.OperatingTemperature,
            operatingPressure: model.OperatingPressure,
            calibrationFrequency: model.CalibrationFrequency,
            failureHistory: model.FailureHistory,
            environmentCondition: model.EnvironmentCondition,
