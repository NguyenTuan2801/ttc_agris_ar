...
public class GlobalVariable : MonoBehaviour
{
    ...
    public static List<string> PLCBoxScene = new List<string>()
    {
        ...
        "PLCBoxGrapA_FlowSensor",
        "PLCBoxGrapA_Valve",
        "PLCBoxGrapA_OtherDevice",
        "PLCBoxGrapB_TemperatureSensor",
        "PLCBoxGrapB_LevelSensor",
        "PLCBoxGrapB_JB",
        "PLCBoxGrapB_PressureSensor",
        "PLCBoxGrapB_FlowSensor",
        "PLCBoxGrapB_Valve",
        "PLCBoxGrapB_OtherDevice",
        "PLCBoxGrapC_TemperatureSensor",
        "PLCBoxGrapC_LevelSensor",
        "PLCBoxGrapC_JB",
        "PLCBoxGrapC_PressureSensor",
        "PLCBoxGrapC_FlowSensor",
        "PLCBoxGrapC_Valve",
        "PLCBoxGrapC_OtherDevice",
        "PLCBoxLH_TemperatureSensor",
        "PLCBoxLH_LevelSensor",
        "PLCBoxLH_JB",
        "PLCBoxLH_PressureSensor",
        "PLCBoxLH_FlowSensor",
        "PLCBoxLH_Valve",
        "PLCBoxLH_OtherDevice",
    };
