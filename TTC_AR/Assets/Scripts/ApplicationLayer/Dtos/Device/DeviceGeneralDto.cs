...
namespace ApplicationLayer.Dtos.Device
{
    ...
    public class DeviceGeneralDto : DeviceBasicDto //! Để GetListDeviceInformation và làm Property cho GetModuleInformation
    {
        ...
        public DeviceGeneralDto(int id, string code, string function, string ioAddress, string type, string modelSeries, string manufacturer, string partNumber, string serialNumber, string manufacturingYear, string installationDate, string measurementType, string range, string unit, string accuracy, string testError, string lengthOrDN, string supplyVoltage, string outputSignal, string ingressProtection, string connectorType, string processConnection, string responseTime, string otherSpecifications, ModuleBasicDto? moduleBasicDto, List<JBBasicDto>? jbBasicDtos, List<ImageBasicDto>? additionalImageBasicDtos) : base(id, code)
        {
