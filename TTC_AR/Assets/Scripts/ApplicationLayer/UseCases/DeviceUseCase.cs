...
namespace ApplicationLayer.UseCases
{
    public class DeviceUseCase
    {
        ...
        private DeviceEntity MapRequestToEntity(DeviceRequestDto requestDto)
        {
            ...
            modelSeries: requestDto.ModelSeries,
            manufacturer: requestDto.Manufacturer,
            partNumber: requestDto.PartNumber,
            serialNumber: requestDto.SerialNumber,
            manufacturingYear: requestDto.ManufacturingYear,
            installationDate: requestDto.InstallationDate,
            ioAddress: requestDto.IOAddress,
            measurementType: requestDto.MeasurementType,
            range: requestDto.Range,
            unit: requestDto.Unit,
            accuracy: requestDto.Accuracy,
            supplyVoltage: requestDto.SupplyVoltage,
            outputSignal: requestDto.OutputSignal,
            ingressProtection: requestDto.ingressProtection,
            connectorType: requestDto.ConnectorType,
            processConnection: requestDto.ProcessConnection,
            responseTime: requestDto.ResponseTime,
            otherSpecifications: requestDto.OtherSpecifications,
            installationLocation: requestDto.InstallationLocation,
            measuredMedium: requestDto.MeasuredMedium,
            operatingTemperature: requestDto.OperatingTemperature,
            operatingPressure: requestDto.OperatingPressure,
            calibrationFrequency: requestDto.CalibrationFrequency,
            failureHistory: requestDto.FailureHistory,
            environmentCondition: requestDto.EnvironmentCondition,
        ...
        private DeviceResponseDto MapToResponseDto(DeviceEntity deviceEntity)
        {
            return new DeviceResponseDto(
                ...
                type: deviceEntity.Type ?? "Chưa cập nhật",
                modelSeries: deviceEntity.ModelSeries ?? "Chưa cập nhật",
                manufacturer: deviceEntity.Manufacturer ?? "Chưa cập nhật",
                partNumber: deviceEntity.PartNumber ?? "Chưa cập nhật",
                serialNumber: deviceEntity.SerialNumber ?? "Chưa cập nhật",
                manufacturingYear: deviceEntity.ManufacturingYear ?? "Chưa cập nhật",
                installationDate: deviceEntity.InstallationDate ?? "Chưa cập nhật",
                ioAddress: deviceEntity.IOAddress ?? "Chưa cập nhật",
                measurementType: deviceEntity.MeasurementType ?? "Chưa cập nhật",
                range: deviceEntity.Range ?? "Chưa cập nhật",
                unit: deviceEntity.Unit ?? "Chưa cập nhật",
                accuracy: deviceEntity.Accuracy ?? "Chưa cập nhật",
                supplyVoltage: deviceEntity.SupplyVoltage ?? "Chưa cập nhật",
                outputSignal: deviceEntity.OutputSignal ?? "Chưa cập nhật",
                ingressProtection: deviceEntity.ingressProtection ?? "Chưa cập nhật",
                connectorType: deviceEntity.ConnectorType ?? "Chưa cập nhật",
                processConnection: deviceEntity.ProcessConnection ?? "Chưa cập nhật",
                responseTime: deviceEntity.ResponseTime ?? "Chưa cập nhật",
                otherSpecifications: deviceEntity.OtherSpecifications ?? "Chưa cập nhật",
                installationLocation: deviceEntity.InstallationLocation ?? "Chưa cập nhật",
                measuredMedium: deviceEntity.MeasuredMedium ?? "Chưa cập nhật",
                operatingTemperature: deviceEntity.OperatingTemperature ?? "Chưa cập nhật",
                operatingPressure: deviceEntity.OperatingPressure ?? "Chưa cập nhật",
                calibrationFrequency: deviceEntity.CalibrationFrequency ?? "Chưa cập nhật",
                failureHistory: deviceEntity.FailureHistory ?? "Chưa cập nhật",
                environmentCondition: deviceEntity.EnvironmentCondition ?? "Chưa cập nhật",
